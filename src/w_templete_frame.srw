HA$PBExportHeader$w_templete_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_templete_frame from window
end type
type mdi_1 from mdiclient within w_templete_frame
end type
end forward
...
string title = "Frame"
string menuname = "m_templete_frame"
...
global w_templete_frame w_templete_frame

type variables
n_templete_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_templete_basesheet aw_sheet)
public function long of_classcount (readonly w_templete_basesheet aw_sheet)
public function integer of_adjustmenu (ref m_templete_frame am_menu)
end prototypes
...
ls_sheets[1] = "w_templete_sheet1"
ls_sheets[2] = "w_templete_sheet2"
ls_sheets[3] = "w_templete_sheet3"

ls_display[1] = "Untitled for Sheet 1"
ls_display[2] = "Untitled for Sheet 2"
ls_display[3] = "Untitled for Sheet 3"
...
inv_sheetmgt = Create n_templete_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_templete_frame.create
if this.MenuName = "m_templete_frame" then this.MenuID = create m_templete_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_templete_frame.destroy
