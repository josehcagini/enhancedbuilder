HA$PBExportHeader$n_templete_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_templete_sheetmanager from nonvisualobject
end type
end forward

global type n_templete_sheetmanager from nonvisualobject
end type
global n_templete_sheetmanager n_templete_sheetmanager

type variables
string is_sheets[], is_display[]
w_templete_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_templete_basesheet aw_sheet)
...
li_rc = OpenSheet ( lw_sheet, as_sheetname, w_templete_frame, 0, Cascaded! ) 
...
w_templete_basesheet lw_sheets[], lw_init[]
...
lm_menu = w_templete_frame.MenuId
...
w_templete_sheet1	lw_sheet1
w_templete_sheet2	lw_sheet2
w_templete_sheet3	lw_sheet3
...
on n_templete_sheetmanager.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_templete_sheetmanager.destroy
