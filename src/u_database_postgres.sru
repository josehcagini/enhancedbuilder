...
public function u_transaction createtransaction (string a_db_dbms, string a_db_sgdb, string a_db_database, string a_db_userid, string a_db_dsn, string a_db_lock, string a_db_autocommit);u_transaction t
transactionFactory _transactionFactory

_transactionFactory = __static.getInstance('transactionfactory')

t = _transactionFactory.createPostgresTransaction(a_db_dbms, a_db_sgdb, a_db_database, a_db_userid, a_db_dsn, a_db_lock, a_db_autocommit)
